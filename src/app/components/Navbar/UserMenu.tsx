...
export default function UserMenu() {
  ...
  return(
    <List component="nav" aria-labelledby="nested-list-subheader" className={classes.list}>
      ...
      <ListItem button onClick={() => setOpenUserList(!openUserList)} style={{width: 300}}>
      ...
      <ListItem button onClick={() => setOpenIdentList(!openIdentList)} style={{width: 300}}>
      ...
      <ListItem button onClick={() => setOpenEnrollList(!openEnrollList)} style={{width: 300}}>
      ...
      <ListItem button onClick={() => setOpenSensorList(!openSensorList)} style={{width: 300}}>
