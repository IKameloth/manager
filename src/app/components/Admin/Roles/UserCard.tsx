...
import { Grid, Card, CardContent, Avatar, Typography, Table, TableHead, TableBody, TableRow, TableCell, CardActions, IconButton, Theme } from '@material-ui/core'
            ...
            <Card style={{ justifyContent: 'center', maxWidth: 345, height: 450, backgroundColor: "#ffffff", borderRadius: '10px', boxShadow: '0px 9px 18px rgba(0, 0, 0, 0.18), 0px 5.5px 5px rgba(0, 0, 0, 0.24)' }}>
                    ...
                    <Table className={classes.miniTable}>
                        ...
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <Typography variant="body2">{email || 'No registrado'}</Typography>
                                </TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                ...
                <CardActions disableSpacing style={{ justifyContent: 'center', alignItems: 'center' }}>
                    <div style={{ marginRight: 5 }} >
                        <IconButton onClick={handleEdit} className={classes.backgroundBtn} aria-label="edit">
